...
export type SingleProfile={id:string;guestId?:string;name:string;age:number;pronouns?:string;side:string;bio:string;interests:string[];photoUrl?:string;photoUrls?:string[];optedIn:boolean};
