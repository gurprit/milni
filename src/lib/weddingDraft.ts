...
export type TravelItem={id:string;name:string;time:string;place:string;note:string;destination?:string;linkedEventId?:string};
export type VenueInfo={name:string;address:string;parking:string;mapUrl:string;taxiInfo:string};
